...
export const QUESTS = [
  ...
  { id: 'q2', text: 'Build a Solar Array for energy', reward: 3000, hint: 'Click "Solar Array" ($4,000) in left panel, place on owned land' },
  { id: 'q3', text: 'Place a Milking Station near your cows', reward: 2000, hint: 'Click "Milking Station" ($4,000) in left panel, then click a green tile near your cows' },
  { id: 'q4', text: 'Grow your herd to 5 Dairy Cows', reward: 1500, hint: 'Click "Dairy Cow" ($1,000) in left panel' },
  { id: 'q5', text: 'Open Tech Tree (T) and unlock GPS Tracking', reward: 2000, hint: 'Press T to open Tech Tree. GPS Tracking is $3,000, Tier 1' },
  ...
  { id: 'q7', text: 'Unlock Health Monitor in Tech Tree', reward: 1500, hint: 'Press T. Health Monitor is $3,000, Tier 1' },
  { id: 'q8', text: 'Unlock Solar Collars in Tech Tree', reward: 1500, hint: 'Press T. Solar Collars is $3,000, Tier 1' },
  { id: 'q9', text: 'Diversify! Buy Sheep, Goats, or Chickens', reward: 1000, hint: 'Click Sheep ($300) or Chicken ($20). Chickens need a Coop ($1,000)' },
  { id: 'q10', text: 'Build a Koi Pond on water', reward: 2000, hint: 'Click "Koi Pond" ($6,000) and place it on a water tile' },
  ...
  { id: 'q15', text: 'Raise Beef Cattle to maturity', reward: 3000, hint: 'Buy Beef Cattle ($900) and wait 60 days for it to mature' },
  ...
  { id: 'q18', text: 'Build an AI Command Center ($23,000)', reward: 5000, hint: 'Save up $23,000. AI Center unlocks Tier 3+ tech' },
